...
export const NEWS_SOURCES: NewsSource[] = [
  ...
  },
  {
    ...
    name: "新智元",
    type: "rss",
    url: "https://posts.careerengine.us/feed",
    category: "research",
    region: "asia",
    enabled: true,
    priority: 8,
  ...
  // 更多中文AI新闻源
  {
    ...
    name: "AI 科技评论",
    type: "rss",
    url: "https://www.leiphone.com/category/ai-tech-review/feed",
    category: "research",
    region: "asia",
    enabled: true,
    priority: 8,
  ...
  // AI产品和工具类新闻
  {
    ...
    type: "rss",
    url: "https://www.producthunt.com/topics/artificial-intelligence/posts.rss",
    category: "product",
    region: "global",
    enabled: true,
    priority: 7,
